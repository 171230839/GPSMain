...
/*
void GPSMain::onLocalServiceCreationSuccess(const QString& url, const QString& name)
{
  Q_UNUSED(url);
  Q_UNUSED(name);
...
/*
void GPSMain::onLocalServiceCreationFailure(const QString& name)
{
...
/*
void GPSMain::onFeatureServiceCreationSuccess(const QString& url, const QString& name)
{
  Q_UNUSED(url);
  Q_UNUSED(name);
...
/*
void GPSMain::onFeatureServiceCreationFailure(const QString& name)
{
  qWarning() << name + " failed to start";
